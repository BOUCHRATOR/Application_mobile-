...
public class etude_note3 extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!matiereText.isEmpty()) {
                    ...
                    Toast.makeText(etude_note3.this, "Please enter a subject", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mDatabase.child("maquette").child("matiere3").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (found) {
                    ...
                    Toast.makeText(etude_note3.this, "No data found for the subject", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(etude_note3.this, "Error fetching data: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void displayAllEntries(Dialog dialog) {
        ...
        mDatabase.child("etudiant").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(etude_note3.this, "Error fetching user data: ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private TableRow createTableRow(HashMap<String, String> noteDetails) {
        TableRow tableRow = (TableRow) LayoutInflater.from(etude_note3.this).inflate(R.layout.table_row2, null);
        TextView nameTextView = tableRow.findViewById(R.id.nameTextView);
        TextView numberTextView = tableRow.findViewById(R.id.numberTextView);
        TextView emailTextView = tableRow.findViewById(R.id.emailTextView);
        TextView emailTextView1 = tableRow.findViewById(R.id.emailTextView1);
        ...
        String noteString3 = String.valueOf(noteDetails.get("note2"));
        ...
        if (noteString != null && !noteString.isEmpty()) {
            ...
            if (note < 6.0) {
                emailTextView8.setBackgroundResource(R.drawable.red_background);
                emailTextView9.setBackgroundResource(R.drawable.red_background);
            } else if (note < 12.0 && note >= 6.0) {
                emailTextView8.setBackgroundResource(R.drawable.yellow_background);
                emailTextView9.setBackgroundResource(R.drawable.yellow_background);
            }else {
                emailTextView8.setBackgroundResource(R.drawable.green_background);
                emailTextView9.setBackgroundResource(R.drawable.green_background);
            }
        }
        ...
        emailTextView6.setText(noteString3);
        emailTextView7.setText(noteDetails.get("bareme3"));
        emailTextView8.setText(noteString);
        emailTextView9.setText(noteDetails.get("validation"));
